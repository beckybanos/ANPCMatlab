...
%iteraciones. En este metodo utilizamos la matriz normal. Realiza la operación
%buscando el elemento necesario de la matriz para operarlo de acuerdo a la iteración
